...
Item
{
    ...
    property Item showFailMessage: midRect.showFailMessage
    property Item onboardTestMessage:midRect.onboardTestMessage
    property Item midRectText:midRect.midRectText
...
//                            toy = avgSpace * lampNum + (avgSpace - rectHeight) / 2 + edgesBoard + i * boardSpace;
        ...
        Rectangle
        {
            ...
            property Item showFailMessage:showFailMessage
            property Item onboardTestMessage:onboardTestMessage
            property Item midRectText:midRectText
            RowLayout
            {
                anchors.fill: parent
                Rectangle
...
//                    Layout.fillWidth: true
                ...
                Rectangle
                {
                    ...
                    anchors.top: parent.top
                    anchors.topMargin: 10
                    anchors.left: showfailMessageRect.right
